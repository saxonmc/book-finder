...
// Test that mockBooks is accessible
console.log('mockBooks loaded:', mockBooks.length, 'books available')

// Search books with mock data
export const useSearchBooks = (query: string, filters?: any, enabled: boolean = true) => {
  console.log('useSearchBooks called:', { query, filters, enabled, queryLength: query?.length })
  ...
  return useQuery<SearchResponse>({
    ...
    queryFn: async () => {
      ...
      console.log('Initial filtered books:', filteredBooks.length, 'for query:', query)
